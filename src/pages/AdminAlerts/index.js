                      ...
                      <div className="card-alerts card-alerts--error w-100 position-relative d-flex flex-column">
                        ...
                        <div className="card-alerts__body d-flex align-items-center">
                          <figure
                            ...
                            style={{
                              backgroundImage:
                                "url('../../images/message/variant_42242.png')",
                            }}
                          ></figure>
                          <div className="card-alerts__info">
                            <h2 className="card-alerts__title mycustomFont">Title here</h2>
                            <div className="card-alerts__detail d-flex flex-wrap">
                              <span>
                                Sku:&nbsp;<span>#134567</span>
                              </span>
                              <span>
                                Qty:&nbsp;<span>20</span>
                              </span>
                    ...
                    <li className="reminders__item">
                      <div className="card-alerts card-alerts--canceled w-100 position-relative d-flex flex-column">
                        ...
                        <div className="card-alerts__body d-flex align-items-center">
                          ...
                          <div className="card-alerts__info">
                            <h2 className="card-alerts__title mycustomFont">
                              Title here could be so much longer so much longer
                              so much longer so much longerso much longer
                            </h2>
                            <div className="card-alerts__detail d-flex flex-wrap">
                              <span>
                                Sku:&nbsp;<span>#134567</span>
                  ...
                  >
                    <div className="form__wrap notification__card">
                      <figure className="internal-card__avatar">
                        <img
                          src="../../images/profiles/user-4.png"
                          alt="avatar"
                        />
                      ...
                      <div className="notification__headline w-100">
                        <div className="notification__head">
                          <span>
                            <b>John Archer</b>&nbsp;requested to join&nbsp;
                            <b>Your Group Name</b>
                          </span>
                        </div>
                    ...
                    <div className="form__wrap notification__card">
                      ...
                      <div className="notification__headline w-100">
                        <strong>
                          Headline here could be longer one because we know{" "}
                        </strong>
                        <p>
                          Grow your business on SplitChek. Sell up to 100
                          products for free
                        </p>
                        <div className="notification__link mycustomFont">
                          <a href="#">Cancel</a>
                      ...
                      <div className="notification__video">
                        <figure className="grid-gallery__width-1-1">
                          <a
                            ...
                            href="images/shop/product.jpg"
                          >
                            <div
                              className="grid-gallery__post-img"
                              style={{
                                backgroundImage:
                                  "url('images/shop/product.jpg')",
                              }}
                            ></div>
                          </a>
                        </figure>
                        <div className="d-flex justify-content-center">
                          <p>
                            Genetix Nutrition products are devoloped by an
                            internal research team assisted by Grant Mayo to
                            ensure the greatest quality and product{" "}
                          </p>
                        </div>
                        <div className="notification__link mycustomFont">
                          <a href="#">Cancel</a>
