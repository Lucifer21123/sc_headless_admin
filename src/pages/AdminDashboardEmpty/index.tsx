...
import { list1Data } from "../../data/adminDashboardEmpty/list1Data";
import { momentData } from "../../data/adminDashboardEmpty/momentData";
import { progressData } from "../../data/adminDashboardEmpty/progressData";
import { topCardsData } from "../../data/adminDashboardEmpty/topCardsData";

interface AdminDashboardEmptyProps {
  isOpen: () => void;
}

const AdminDashboardEmptyContent: React.FC<AdminDashboardEmptyProps> = (props) => {
              ...
              <div className={`toogle-box__header ${isCard2Open && 'open'}`}>
                ...
                <div className="toogle-box__header--right">
                  <button className={`reset ${isLotate ? 'anim' : ''}`}>
                    <img src="../../images/icons/loop-24px.svg" alt="reset" onClick={() => setIsLotate(!isLotate)}/>
                  </button>
            ...
            <section className="section-content section-content--dashboard">
              ...
              <div className="statistic">
                <ul className="statistic__list d-flex flex-wrap align-items-center justify-content-between list-unstyled mb-0">
                  {topCardsData.map((item: any, index: number) => (
