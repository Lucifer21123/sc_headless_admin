...
import {sidebarInfo} from '../../data/sidebar/sidebarInfo';

interface SideBarProps {
  isHide: boolean;
  setIsHeader: (isHide: boolean) => void;
}

const Sidebar: React.FC<SideBarProps> = (props) => {
  const {isHide, setIsHeader} = props;
              ...
              <form action="#" className="form form-admin-menu">
                <div className="form__wrap">
                  ...
                  <div className="form__single form__single--fluid form__single--checkbox form__single--checkbox-left">
                    ...
                    />
                    <label
                    //  for="checkbox-alert-admin-menu2"
                    >
